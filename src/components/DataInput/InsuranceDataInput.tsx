...
const RIDER_GROUPS: Array<{
  ...
  },
  {
    ...
    secondaryCats: ['stroke', 'brain_hemorrhage', 'specific_cerebrovascular'],
  ...
  },
  {
    ...
    secondaryCats: ['ami', 'specific_ischemic_heart'],
...
function getCategoryLabel(category: string): string {
  const labels: Record<string, string> = {
    ...
    stroke:           '뇌졸중',
    cerebrovascular:  '뇌혈관',
    specific_cerebrovascular: '특정뇌혈관',
    ami:              '심근경색',
    specific_ischemic_heart: '특정허혈심장',
    ischemic_heart:   '허혈성',
    ci_gi:            'CI/GI',
    loss:             '실손',
    disability:       '장해',
